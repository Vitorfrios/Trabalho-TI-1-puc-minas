...
| :----------------------------: | :-------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|       **Página Inicial**       |       ![Wireframe - Página inicial](https://example.com/pagina-inicial.png)       | Página inicial da plataforma, onde o usuário poderá ler sobre o projeto e acessar a página de acesso à conta.                                                                                                                                              |
| **Página de Login e Registro** | ![Wireframe - Página de login e registro](https://example.com/login-registro.png) | Página que permite o usuário entrar na sua conta ou se registrar caso não possua uma conta. Possui um formulário simples para inserir os dados.                                                                                                            |
|          **Tutorial**          |             ![Wireframe - Tutorial](https://example.com/tutorial.png)             | Página que apresenta um guia interativo para os novos usuários, com explicações detalhadas sobre as funcionalidades do sistema, permitindo navegação entre os slides ou a opção de pular o tutorial.                                                       |
|         **Dashboard**          |            ![Wireframe - Dashboard](https://example.com/dashboard.png)            | Página principal após login, que exibe as tarefas a serem concluídas, junto da opção de criar ou deletar tarefas. Além disso, pode visualizar um calendário com as tarefas e uma breve preview da página de Análise.                                       |
|         **Cronograma**         |           ![Wireframe - Cronograma](https://example.com/cronograma.png)           | Página que exibe o cronograma de hora em hora dos dias da semana atual. Possui uma legenda de cor por nível de prioridade das tarefas e um botão de atalho para a criação de tarefas, página de sugestões e para inserir o horário em que o usuário dorme. |
|     **Criação de Tarefas**     |    ![Wireframe - Criação de tarefas](https://example.com/criacao-tarefas.png)     | Página dedicada à criação de tarefas. Permite ao usuário adicionar detalhes como nome, data/hora, prioridade e categoria. Também oferece a opção de definir notificações e criar tarefas recorrentes.                                                      |
|         **Sugestões**          |        ![Wireframe - Sugestões e dicas](https://example.com/sugestoes.png)        | Página com listas de sugestões e dicas para o usuário com a opção de selecionar o tema. Possui também um quadro de horários e dias mais vagos.                                                                                                             |
|     **Dicas para Estudo**      |      ![Wireframe - Dicas para Estudo](https://example.com/dicas-estudo.png)       | Página dedicada a oferecer técnicas de estudo, como o método Pomodoro e mapas mentais, ajudando o usuário a organizar seu tempo de forma eficiente.                                                                                                        |
|    **Dicas para Descansar**    |   ![Wireframe - Dicas para Descansar](https://example.com/dicas-descansar.png)    | Página voltada ao bem-estar do usuário, com orientações sobre hábitos de sono saudáveis, cálculo de ciclos de sono e horários ideais para dormir e acordar, promovendo um descanso mais eficiente.                                                         |
|    **Dicas de Desempenho**     |   ![Wireframe - Dicas de Desempenho](https://example.com/dicas-desempenho.png)    | Página que fornece sugestões para melhorar a produtividade, como técnicas de organização, foco em metas e priorização de tarefas, com base no desempenho atual e nos hábitos do usuário.                                                                   |
|           **Perfil**           |     ![Wireframe - Perfil do usuário](https://example.com/perfil-usuario.png)      | Página com as informações do perfil do usuário. Permitindo a opção de alterá-las ou deletar a conta.                                                                                                                                                       |
|      **Suporte/Feedback**      |     ![Wireframe - Suporte/Feedback](https://example.com/suporte-feedback.png)     | Página destinada ao envio de dúvidas, sugestões ou relatórios de problemas. Oferece um formulário simples e eficiente, com campos obrigatórios para categoria e descrição, além de confirmação de recebimento.                                             |
...
![Kanban][kanban] ![Planejamento das Sprints][planejamento]![Notas e próximos passos][notas]
