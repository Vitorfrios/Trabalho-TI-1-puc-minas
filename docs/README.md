...
| <p>- [Introdução](#introducao)</p><p>- [Contexto](#contexto)</p><p>- [Projeto de Design thinking](#design-thinking)</p><p>- [Personas](#personas)</p><p>- [Requisitos](#requisitos)</p><p>- [Ações do Usuário](#acoes)</p><p>- [Projeto de Interfaces](#projetos)</p><p>- [Metodologia](#metodologia)</p> |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
|         _7. Tela de Sugestão_          |                             - Exibir tres tipos de sugestões:<br>1\. Dicas para estudo<br>2\. Dicas para Descansar/dormir<br>3\. Dicas para bom desempenho.                              | - Sugestões claras e interativas<br>- Análise rápida e baseada em dados reais<br>- Layout compatível com dispositivos móveis e desktops, oferecendo uma experiência fluida. |
|          _8. Tela de Perfil_           | - Permite editar informações pessoais:   - Nome completo   - Idade   - Email   - Nome de usuário <br>- Configurações de preferências, como notificações. |            - Design simples e acessível<br>- Alteração dos dados do perfil incluindo senha <br>- Configuração de notificações para manter o usuário atualizado.             |
...
|         _4. Tela de Dashboard_         |                                                                                 - Menu navegação de 4 opções <br>- Área de mostragem de tarefas <br>- Clique no calendário para exibir as tarefas <br>- Mostra um gráfico com base no tempo gasto em cada categoria                                                                                  |
| _5. Tela de Cronograma Diário/Semanal_ |                                                  - Visualizar tarefas durante um período de 7 dias <br>- Filtrar semana do mês: Selecionar a semana que deseja visualizar <br>- Ver sugestões/dicas: Vai para a página de sugestões <br>- Adicionar tarefa: Vai para a página de criação de tarefas                                                  |
|    _6. Tela de Criação de Tarefas_     | - Escreva o nome da tarefa <br>- Escolha os dias de repetição de tarefas (se quiser) <br>- Escolha a hora, o dia e a prioridade da tarefa <br>- Escolha as categorias (lazer/trabalho/estudo) <br>- Área de mostragem de tarefas <br>- Clique no calendário para exibir as tarefas <br>- Mostra um gráfico com base no tempo gasto em cada categoria |
|         _7. Tela de Sugestão_          |                                                                                                                        - Menu navegação de 3 opções <br>- Ajuda com horários <br>- Dicas de estudo <br>- Dicas para descansar                                                                                                                        |
|        _7.1 Dicas para Estudo_         |                                                                                                                          - Clique na roleta para exibir as 4 dicas <br>- Técnicas de estudo <br>- Organizar tempo de estudo                                                                                                                          |
|        _7.2 Dicas para Dormir_         |                                                                - Clique na roleta para exibir as 4 dicas <br>- Calcular horário de dormir e acordar <br>- Digite o horário de deitar <br>- Digite o horário do compromisso <br>- Exibir a hora de acordar <br>- Exibir tempo de sono                                                                 |
| _7.3 Dicas para ter um bom desempenho_ |                                                                                                      - Clique na roleta para exibir as 4 dicas <br>- Mostra o tanto de tarefas por categoria <br>- Mostra o tanto de horas gastas por categoria                                                                                                      |
|     _8. Tela de Perfil do Usuário_     |                                                                                                                              - Editar nome completo <br>- Editar idade <br>- Editar email <br>- Editar nome de usuário                                                                                                                               |
|     _9. Tela de Suporte/Feedback_      |                                                                                                - Preencher e enviar o formulário de feedback/suporte<br>- Aguardar a confirmação de recebimento. - Enviar feedback <br>- Obter ajuda com o aplicativo                                                                                                |
...
| :----------------------------: | :-------------------------------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|       **Página Inicial**       |       ![Wireframe - Página inicial](images/wireframePaginaInicial.png)       | Página inicial da plataforma, onde o usuário poderá ler sobre o projeto e acessar a página de acesso à conta.                                                                                                                                              |
| **Página de Login e Registro** | ![Wireframe - Página de login e registro](images/wireframeLogin.jpg) | Página que permite o usuário entrar na sua conta ou se registrar caso não possua uma conta. Possui um formulário simples para inserir os dados.                                                                                                            |
|          **Tutorial**          |             ![Wireframe - Tutorial](images/wireframeTutorial.jpg)             | Página que apresenta um guia interativo para os novos usuários, com explicações detalhadas sobre as funcionalidades do sistema, permitindo navegação entre os slides ou a opção de pular o tutorial.                                                       |
|         **Dashboard**          |            ![Wireframe - Dashboard](images/wireframeDashboard.png)            | Página principal após login, que exibe as tarefas a serem concluídas, junto da opção de criar ou deletar tarefas. Além disso, pode visualizar um calendário com as tarefas e uma breve preview da página de Análise.                                       |
|         **Cronograma**         |           ![Wireframe - Cronograma](images/wireframeCronograma.jpg)           | Página que exibe o cronograma de hora em hora dos dias da semana atual. Possui uma legenda de cor por nível de prioridade das tarefas e um botão de atalho para a criação de tarefas, página de sugestões e para inserir o horário em que o usuário dorme. |
|     **Criação de Tarefas**     |    ![Wireframe - Criação de tarefas](images/wireframeTarefas.jpg)     | Página dedicada à criação de tarefas. Permite ao usuário adicionar detalhes como nome, data/hora, prioridade e categoria. Também oferece a opção de definir notificações e criar tarefas recorrentes.                                                      |
|         **Sugestões**          |        ![Wireframe - Sugestões e dicas](images/wireframeSugestoes.jpg)        | Página com listas de sugestões e dicas para o usuário com a opção de selecionar o tema. Possui também um quadro de horários e dias mais vagos.                                                                                                             |
|     **Dicas para Estudo**      |      ![Wireframe - Dicas para Estudo](images/wireframeEstudo.jpg)       | Página dedicada a oferecer técnicas de estudo, como o método Pomodoro e mapas mentais, ajudando o usuário a organizar seu tempo de forma eficiente.                                                                                                        |
|    **Dicas para Descansar**    |   ![Wireframe - Dicas para Descansar](images/wireframeDormir.jpg)    | Página voltada ao bem-estar do usuário, com orientações sobre hábitos de sono saudáveis, cálculo de ciclos de sono e horários ideais para dormir e acordar, promovendo um descanso mais eficiente.                                                         |
|    **Dicas de Desempenho**     |   ![Wireframe - Dicas de Desempenho](images/wireframeDesempenho.jpg)    | Página que fornece sugestões para melhorar a produtividade, como técnicas de organização, foco em metas e priorização de tarefas, com base no desempenho atual e nos hábitos do usuário.                                                                   |
|           **Perfil**           |     ![Wireframe - Perfil do usuário](images/wireframePerfil.png)      | Página com as informações do perfil do usuário. Permitindo a opção de alterá-las ou deletar a conta.                                                                                                                                                       |
|      **Suporte/Feedback**      |     ![Wireframe - Suporte/Feedback](images/wireframeSuporteFeedback.jpg)     | Página destinada ao envio de dúvidas, sugestões ou relatórios de problemas. Oferece um formulário simples e eficiente, com campos obrigatórios para categoria e descrição, além de confirmação de recebimento.                                             |
